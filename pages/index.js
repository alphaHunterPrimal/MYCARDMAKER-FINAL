...
if(BG == "Construction"){
 ...
 <Content>
      <Card id="CARD" >
        ...
        <Top >
        <span className={CUSTO} hidden={(BG == "Queen" ||BG == "Biome")}>{`${custoM}`}</span>
        {//o span na carta com o valor do custo em energia
        /*
        <span className={CUSTOE} hidden={(BG == "Queen" ||BG == "Biome") && energia == false}>{`${custoE}`}</span>
        */}
      ...
      <Maker>
        <form onSubmit={(dados)=>{
          ...
          {// criar uma opcão de colocar com ou sem energia
            /*
            <label for="variante" hidden={(BG == "Queen" ||BG == "Biome")}> Variante </label>
            <select id="variante" hidden={(BG == "Queen" ||BG == "Biome")} className="variante" onChange={(dados) =>{
          ...
          <label for="custoM" hidden={(BG == "Queen" ||BG == "Biome")}>CustoM</label>
          <Input id="custoM" hidden={(BG == "Queen"||BG == "Biome")} name="custoM" type="number" min="0" onChange={(dados) =>{setCustoM(dados.target.value)}} value={custoM}/>
